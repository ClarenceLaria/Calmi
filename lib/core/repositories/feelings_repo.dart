...
final List<Feeling> feelingsList = [
  ...
  const Feeling(feeling: 'Relaxed', emoji: 'assets/icons/relax.png'),
  const Feeling(feeling: 'Excited', emoji: 'assets/icons/excited.png'),
  const Feeling(feeling: 'Surprised', emoji: 'assets/icons/surprised.png'),
  const Feeling(feeling: 'Sad', emoji: 'assets/icons/sadness.png'),
  const Feeling(feeling: 'Stressed', emoji: 'assets/icons/stressed.png'),
  const Feeling(feeling: 'Upset', emoji: 'assets/icons/upset.png'),
  const Feeling(feeling: 'Grateful', emoji: 'assets/icons/grateful.png'),
  const Feeling(feeling: 'Inspired', emoji: 'assets/icons/inspired.png'),
